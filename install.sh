...
wget --show-progress -q -O ~/.local/share/nautilus-python/extensions/code-nautilus.py https://raw.githubusercontent.com/benjaminsaljooghi/code-nautilus/master/code-nautilus.py
